# [Check if String is Palindrome or Not](https://takeuforward.org/practice/dsa/check-if-string-is-palindrome-or-not-?category=basic-recursion&source=strivers-a2z-dsa-sheet)
...
Given a string **s, r** eturn **true** if the string is palindrome, otherwise **false** .
